...
const meta: Meta<typeof BackgroundColor> = {
  title: "x/video-manager/video-components/BackgroundColor",
...
export const Default: Story = {
  args: { comp: { id: "bg1", type: "BACKGROUND_COLOR", startTime: 0, color: "default" } },
};

export const Paper: Story = {
  args: { comp: { id: "bg2", type: "BACKGROUND_COLOR", startTime: 0, color: "paper" } },
};
