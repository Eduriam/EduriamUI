...
import { ExerciseStudyBlockComponentType } from "./components/study-blocks/exercise/components/ExerciseStudyBlockComponentTypes";
...
const StudySessionWithReportDialogStory: React.FC = () => {
  ...
  const [reportTarget, setReportTarget] =
    useState<SelectedStudyBlockData | null>(null);
            ...
            components: [
              {
                ...
                options: [
                  {
                    id: "read",
                    text: "Read or retrieve data from the database",
                  },
